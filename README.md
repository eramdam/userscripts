...
| [Force Bsky.app to desktop mode](https://github.com/eramdam/userscripts/blob/main/bluesky%20force%20desktop.user.js)          | Eramdam  | Force Bsky.app to desktop mode (left sidebar with item names) and hides the right sidebar   |
| [Hide metrics on Bsky.app](https://github.com/eramdam/userscripts/blob/main/bluesky-hide-metrics.user.css)                    | @Eramdam | What it says on the tin.                                                                    |
